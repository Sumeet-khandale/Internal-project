...
public class JwtAuthenticationController {
    ...
    public JwtAuthenticationController(JwtTokenUtil jwtTokenUtil, JdbcTemplate jdbcTemplate) {
    ...
    private boolean isUsernameInDatabase(String username) {
        String sql = "SELECT COUNT(*) FROM userservice.users WHERE LOWER(username) = ?";
        Integer count = jdbcTemplate.queryForObject(sql, Integer.class, username);
        return count != null && count > 0;
    }

    private AuthenticationStatus authenticate(String username, String password) {
        // TODO: Add real password check later
